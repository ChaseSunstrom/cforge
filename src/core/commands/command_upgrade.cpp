...
cforge_int_t cforge_cmd_upgrade(const cforge_context_t *ctx) {
  ...
  std::filesystem::path temp_dir = std::filesystem::temp_directory_path() / "cforge_upgrade_temp";
  ...
  std::vector<std::filesystem::path> possible_paths = {build_dir / "bin" / "Release" / "cforge.exe",
