...
cforge_int_t cforge_cmd_help(const cforge_context_t *ctx) {
  ...
  if (specific_command.empty()) {
    ...
    cforge::logger::print_plain("");
    cforge::logger::print_plain("  Project Management:");
    ...
    cforge::logger::print_plain("");
    cforge::logger::print_plain("  Build & Run:");
    ...
    cforge::logger::print_plain("");
    cforge::logger::print_plain("  Testing & Quality:");
    ...
    cforge::logger::print_plain("    circular    Detect circular include dependencies");
    cforge::logger::print_plain("");
    cforge::logger::print_plain("  Dependencies (use 'cforge deps <subcommand>'):");
    cforge::logger::print_plain("    deps add       Add a dependency");
    cforge::logger::print_plain("    deps remove    Remove a dependency");
    cforge::logger::print_plain("    deps search    Search for packages");
    cforge::logger::print_plain("    deps info      Show package information");
    cforge::logger::print_plain("    deps tree      Visualize dependency tree");
    cforge::logger::print_plain("    deps lock      Manage lock file");
    cforge::logger::print_plain("    deps outdated  Show outdated dependencies");
    cforge::logger::print_plain("    deps update    Update package registry");
    cforge::logger::print_plain("    deps list      List current dependencies");
    cforge::logger::print_plain("");
    cforge::logger::print_plain("  Distribution:");
    ...
    cforge::logger::print_plain("");
    cforge::logger::print_plain("  Other:");
    cforge::logger::print_plain("    update      Update cforge itself (--self)");
    ...
    cforge::logger::print_plain("    doctor      Diagnose environment issues");
    ...
    cforge::logger::print_plain("  outdated           Show dependencies with newer versions available");
    cforge::logger::print_plain("  list               List current project dependencies");
    cforge::logger::print_plain("  vcpkg              Direct vcpkg command access");
    cforge::logger::print_plain("");
    cforge::logger::print_plain("Add Options:");
    cforge::logger::print_plain("  --git <url>        Add as Git dependency");
    cforge::logger::print_plain("  --tag <tag>        Git tag (with --git)");
    cforge::logger::print_plain("  --branch <name>    Git branch (with --git)");
    cforge::logger::print_plain("  --vcpkg            Add as vcpkg package");
    ...
    cforge::logger::print_plain("  cforge deps info nlohmann_json --versions");
    ...
    cforge::logger::print_plain("  cforge deps list --json");
    cforge::logger::print_plain("");
    cforge::logger::print_plain("Note: Legacy commands 'add', 'remove', 'search', 'info', 'tree', 'lock'");
    cforge::logger::print_plain("      still work as top-level commands for backward compatibility.");
    cforge::logger::print_plain("");
